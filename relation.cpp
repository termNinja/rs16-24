    ...
    QPoint tmpPointClass2;
        ...
        switch(m_firstClassPointPosition)
        {
            case 0: tmpPointClass1 = QPoint( startPoint.x() - 10 , startPoint.y());
                    bonusLineClass1 = new relationLine(parent,tmpPointClass1,startPoint);
                    break;

            case 1: tmpPointClass1 = QPoint( startPoint.x() , startPoint.y()+10);
                    bonusLineClass1 = new relationLine(parent ,
                                                       tmpPointClass1,startPoint );
                    break;

            case 2: tmpPointClass1 = QPoint( startPoint.x() + 10 , startPoint.y());
                    bonusLineClass1 = new relationLine(parent ,startPoint , tmpPointClass1);
                    break;
        ...
        switch(m_secondClassPointPosition)
        {
            case 0: tmpPointClass2 = QPoint( endPoint.x() - 10 ,  endPoint.y());
                    bonusLineClass2 = new relationLine(parent,tmpPointClass2,endPoint);
                    break;

            case 1: tmpPointClass2 = QPoint(  endPoint.x() ,  endPoint.y()+10);
                    bonusLineClass2 = new relationLine(parent ,
                                                       tmpPointClass2, endPoint );
                    break;

            case 2: tmpPointClass2 = QPoint(  endPoint.x() + 10 ,  endPoint.y());
                    bonusLineClass2 = new relationLine(parent , endPoint , tmpPointClass2);
                    break;
             ...
             class1->pos().y() > class2->pos().y())
        {
         relationLine *firstLine = new relationLine(parent ,tmpPointClass1 ,
                                                    QPoint( tmpPointClass2.x() , startPoint.y()));
             ...
             class1->pos().y() < class2->pos().y())
        {
         ...
         relationLine *secondLine = new relationLine(parent , tmpPointClass2 ,QPoint( tmpPointClass2.x() , startPoint.y())                                                     );
        }
             ...
             class1->pos().y() < class2->pos().y())
        {
         ...
         relationLine *firstLine = new relationLine(parent , QPoint( tmpPointClass2.x() , startPoint.y()) ,tmpPointClass1
                                                    );
             ...
             class1->pos().y() > class2->pos().y())
        {
         ...
         relationLine *secondLine = new relationLine(parent ,QPoint( tmpPointClass2.x() , startPoint.y())  , tmpPointClass2);
        }
}
